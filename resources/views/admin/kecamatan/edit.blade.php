...
<div class="px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900">Edit Kecamatan</h1>
            ...
            <form action="{{ route('admin.kecamatan.update', $kecamatan->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <input type="text" name="nama" id="nama" value="{{ old('nama', $kecamatan->nama) }}" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm px-3 py-2 border">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            ...
                            <input type="number" name="ongkir" id="ongkir" value="{{ old('ongkir', $kecamatan->ongkir?->ongkir ?? 0) }}" min="0" required class="block w-full min-w-0 flex-1 rounded-none rounded-r-md border-gray-300 focus:border-green-500 focus:ring-green-500 sm:text-sm px-3 py-2 border">
                        </div>
                    </div>
                </div>
