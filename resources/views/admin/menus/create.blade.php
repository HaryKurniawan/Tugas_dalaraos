...
<div class="px-4 sm:px-6 lg:px-8 max-w-4xl">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-semibold text-gray-900 mt-2">Tambah Menu Baru</h1>
    </div>
            ...
            <div class="col-span-2 p-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea id="isi_paket" name="isi_paket" rows="4"
                              ...
                              class="block w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-green-500 focus:ring-green-500">{{ old('isi_paket') ? implode("\n", (array) old('isi_paket')) : '' }}</textarea>
